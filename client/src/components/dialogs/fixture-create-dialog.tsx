...
const fixtureCreateSchema = z.object({
  ...
  homeScore: z.union([z.coerce.number(), z.literal("")]).optional().transform(v => v === "" || v === undefined ? undefined : v),
  awayScore: z.union([z.coerce.number(), z.literal("")]).optional().transform(v => v === "" || v === undefined ? undefined : v),
