...
export function PlayerDetailsModal({ player, open, onOpenChange, onPlayerUpdate }: PlayerDetailsModalProps) {
  ...
  const photoUploadMutation = useMutation({
    mutationFn: async (photoURL: string) => {
      const response = await fetch(`/api/user/${player?.id}/photo`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
            ...
            <CardContent className="p-0">
              ...
              <div className="px-6 pb-4">
                <div className="pt-4 flex items-center justify-center relative">
                  <TabsList className="grid grid-cols-3 w-auto bg-transparent border-none p-0 h-auto">
                    <TabsTrigger 
                      value="details" 
                      ...
                      <div className="w-4/5 mx-auto space-y-8">
                        ...
                        <div className="text-center">
                          ...
                          <div className="flex flex-col items-center space-y-4">
                            ...
                            <div 
                              className="w-48 h-64 border-4 border-gray-200 rounded-lg overflow-hidden flex items-center justify-center"
                              style={{
                                background: `
