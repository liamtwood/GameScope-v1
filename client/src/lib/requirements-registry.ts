...
export const requirementsRegistry: PageRequirements[] = [
  ...
  },
  {
    ...
    acceptanceCriteria: [
      ...
      { id: "AC-017", description: "Home section pages load in under 3 seconds" },
      { id: "AC-018", description: "Club branding applied consistently across all Home pages" },
    ],
  },
  ...
  // =============================================================================
  {
    ...
    acceptanceCriteria: [
      ...
      { id: "AC-026", description: "Dashboard loads in under 2 seconds" },
      { id: "AC-027", description: "Data refreshes automatically when team is changed" },
    ],
  },
  ...
  // =============================================================================
  {
    ...
    acceptanceCriteria: [
      ...
      { id: "AC-069", description: "Fixtures page handles 500+ fixtures without performance issues" },
      { id: "AC-070", description: "All fixture operations confirm with database before showing success" },
      { id: "AC-071", description: "Fixture data persists after page refresh" },
    ],
  },
  {
    id: "fixture-details",
  ...
  // =============================================================================
  {
    ...
    acceptanceCriteria: [
      ...
      { id: "AC-093", description: "Squad page handles 100+ players without performance issues" },
      { id: "AC-094", description: "Error messages are user-friendly (not raw exceptions)" },
      { id: "AC-095", description: "All squad operations confirm with database before showing success" },
    ],
  },
  ...
  // =============================================================================
  {
    ...
    acceptanceCriteria: [
      ...
      { id: "AC-110", description: "Player profiles page loads in under 2 seconds" },
    ],
  },
  ...
  },
  {
    ...
    acceptanceCriteria: [
      ...
      { id: "AC-148", description: "User pages load in under 2 seconds" },
      { id: "AC-149", description: "All user operations confirm with database before showing success" },
    ],
  },
  ...
  // =============================================================================
  {
    ...
    acceptanceCriteria: [
      ...
      { id: "AC-179", description: "DevOps module only accessible to DevOps role" },
      { id: "AC-180", description: "All operations confirm with database before showing success" },
    ],
  },
];
