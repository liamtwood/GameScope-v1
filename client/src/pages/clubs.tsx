    ...
    <div className="w-full">
      <div className="grid grid-cols-3 gap-4 text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-xs font-medium mt-1 text-muted-foreground">Teams</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="text-2xl font-bold text-foreground" data-testid={`text-club-fixtures-${clubId}`}>
            {stats.processing}
          </span>
          <span className="text-xs font-medium mt-1 text-muted-foreground">Fixtures</span>
        </div>
      </div>
    </div>
  );
...
export default function Clubs() {
  ...
  // Fetch admin users for owner selection
  const { data: adminUsersForCreate = [] } = useAdminUsers();
  ...
  const handleEditClub = (club: Club) => {
    ...
    editForm.reset({
      ...
      owner: club.owner,
      ownerFirstName: (club as any).ownerFirstName || "",
      ownerLastName: (club as any).ownerLastName || "",
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <DialogHeader>
              ...
              <DialogDescription>Create new GameScope Club</DialogDescription>
            </DialogHeader>
            <Form {...form}>
