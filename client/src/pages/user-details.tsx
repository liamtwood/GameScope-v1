                  ...
                  <div className="relative group">
                    ...
                    <div className="absolute -bottom-1 -right-1 z-10">
                      <ObjectUploader
                        ...
                        buttonClassName="bg-green-500 border-2 border-white/30 rounded-full p-2 opacity-80 hover:opacity-100 transition-opacity shadow-lg z-10 cursor-pointer [&_svg]:!w-3 [&_svg]:!h-3"
                      >
